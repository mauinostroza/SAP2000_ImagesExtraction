...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ruta",
        default=os.path.join(os.getcwd(), "SAP2000_Capturas.xlsx"),
    ...
    print("  2. Completa la hoja CAPTURAS con las vistas que necesitas")
    print("  3. Guárdalo como .xlsm y agrega el módulo VBA (SAP_Capturas_VBA.bas)")
    print("  4. Abre SAP2000 con tu modelo")
    print("  5. Ejecuta la macro CapturarImagenes()")
